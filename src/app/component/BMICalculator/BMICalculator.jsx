...
{/* Left side */}
        {/* Input Section */}
        <div className="flex justify-center flex-1 w-full h-[70%]">
          <motion.div
            className="w-full bg-white text-gray-900 rounded-2xl border border-gray-300 shadow-xl overflow-hidden"
...
>
  {/* Before Calculation */}
  {!bmi && (
  <div className="w-full py-16 flex flex-col items-center justify-center text-center space-y-4 border border-dashed border-gray-400 rounded-2xl p-6 h-[70%] bg-gray-50">
    {/* Animated Icon */}
    <motion.div
      initial={{ scale: 0 }}
    ...
    <motion.p
      ...
      className="text-gray-600 text-sm md:text-base max-w-sm"
    >
      Enter your <span className="font-semibold">weight</span>,{" "}
      <span className="font-semibold">height</span>, and{" "}
      <span className="font-semibold">age</span> in the form to calculate your
      Body Mass Index.
    </motion.p>
  </div>
)}
  ...
  {/* After Calculation - Circular Gauge */}
  {bmi && (
    <div className="w-full px-4">
      ...
      <div className="relative flex flex-col items-center mb-6">
        ...
        <div className="absolute inset-0 flex flex-col  items-center justify-center text-center ">
          ...
          <p className="text-sm font-medium text-gray-700 w-30 ">{category}</p>
        </div>
      </div>
    </div>
  )}
  ...
  <div className="w-full max-w-md mt-6 space-y-4">
    ...
    <div className="grid grid-cols-2 sm:grid-cols-3 gap-3">
      {(age >= 18 ? categoriesAdult : categoriesChildren).map((c, index) => (
        ...
        >
          <p className="font-semibold text-gray-600">{c.name}</p>
