...
//                 {/* Message Bubble */}
//                 <div
//                   className={`px-4 py-2 rounded-2xl shadow text-sm sm:text-base whitespace-pre-line ${
//                     msg.sender === "user"
//                       ? "bg-green-600 text-white rounded-br-none"
//                       : "bg-white text-gray-800 rounded-bl-none"
//                   }`}
...
//             onClick={handleSend}
//             disabled={loading}
//             className={`px-5 py-2 rounded-full shadow transition flex items-center justify-center ${
//               loading
    ...
    <div className="min-h-screen flex flex-col bg-[#f0f9f3] text-gray-700">
      ...
      <footer className="bg-white border-t border-gray-200">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 py-3 flex items-center gap-3">
          ...
          >
            {loading ? <span className="animate-pulse">...</span> : <FaPaperPlane />}
          </button>
        </div>
      </footer>
    </div>
