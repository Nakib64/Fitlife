    ...
    <TooltipProvider>
      <Tooltip>
        <TooltipTrigger asChild>
          <Link href="/dashBoard">
            <div className="flex items-center gap-3 bg-white border border-gray-200 rounded-full px-3 py-1.5 cursor-pointer hover:bg-lime-50 hover:border-lime-300 transition-all duration-300 shadow-sm hover:shadow-md">
              {session.user?.image ? (
                <Image
        ...
        <TooltipContent side="bottom" className="bg-lime-100 text-gray-800 border border-lime-300 shadow-md font-medium">
          <p>Dashboard</p>
        </TooltipContent>
      </Tooltip>
    </TooltipProvider>
