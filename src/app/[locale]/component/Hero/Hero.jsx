      ...
      >
        ...
        <div className="text-center lg:text-left mb-20">
          ...
          <motion.div
            ...
            variants={itemVariants}
          >
            <Link className="w-full sm:w-auto bg-lime-400 text-zinc-900 font-bold px-8 py-4 rounded-full text-lg hover:bg-lime-500 transition-colors duration-300 focus:outline-none focus:ring-2 focus:ring-lime-400 focus:ring-offset-2" href={'/myworkouts'}>
              {t("btn")}
            </Link>
          </motion.div>
        </div>
